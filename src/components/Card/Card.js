          ...
          <CardContent style={{ display: "flex", flexDirection: "column",padding:0,fontFamily:"Varela Round" }}>
            ...
            <CardActions>
              {!isAdded?(
                ...
                sx={{ width:"100%",fontSize:"15px",backgroundColor:"red",padding:"8 0 8 0",borderRadius:0,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Varela Round",":hover": {
                  ...
                  variant="contained"
                >
                  <LocalGroceryStoreIcon style={{fontSize:"large",height:"19px",width:"19px"}}/>   REMOVE FROM CART
              </Button>)}
